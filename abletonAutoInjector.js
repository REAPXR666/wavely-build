 ...
 * Injects Wavely React UI safely into Ableton Live's Places browser container
 */
async function autoInjectAbletonLive() {
  ...
  console.log(`[AbletonInjector] Found ${targets.localAppDataSpliceDirs.length} AppData target(s).`);
